      ...
      <div className="px-6 space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <button className="w-full flex items-center justify-center gap-3 h-12 bg-zinc-900 border border-zinc-800 rounded-lg hover:bg-zinc-800 transition-colors">
              ...
              <span className="text-sm font-medium text-white">Connect Google</span>
            </button>
            ...
            <button className="w-full flex items-center justify-center gap-3 h-12 bg-zinc-900 border border-zinc-800 rounded-lg hover:bg-zinc-800 transition-colors">
              ...
              <span className="text-sm font-medium text-white">Connect Outlook</span>
            </button>
